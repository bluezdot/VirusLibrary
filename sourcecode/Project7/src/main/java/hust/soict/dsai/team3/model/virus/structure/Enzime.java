...
public class Enzime extends VirusComponent{
    public Enzime(String urlOverview, String urlDetail, String info, String name){
        super(urlOverview,urlDetail, info, name);
    }

    public static Enzime parse(File folder) throws Exception{
        String info = "";
        String overview = "";
        String detail = "";
        ...
        return new Enzime(overview,detail, info, folder.getName());
    }
